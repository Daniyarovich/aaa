...
def newmain():
    ...
    def BUYUAH():
        ...
        insertvalue('RUB',0,'BUY','RUBfiatbalance', "D17",a)
        insertvalue('RUB',0,'BUY','Advcash', "E17",a)
        insertvalue('RUB',0,'BUY','Advcash', "F17",a)
        insertvalue('RUB',0,'BUY','Payeer', "G17",a)
        insertvalue('RUB',0,'BUY','Payeer', "H17",a)
        insertvalue('RUB',0,'BUY','QIWI', "I17",a)
        insertvalue('RUB',0,'BUY','QIWI', "J17",a)
        insertvalue('RUB',0,'BUY','YandexMoneyNew', "K17",a)
        insertvalue('RUB',0,'BUY','YandexMoneyNew', "L17",a)
        insertvalue('RUB',0,'BUY','Tinkoff', "M17",a)
        insertvalue('RUB',0,'BUY','Tinkoff', "N17",a)
        insertvalue('RUB',0,'BUY','RosBank', "O17",a)
        insertvalue('RUB',0,'BUY','RosBank', "P17",a)
        insertvalue('RUB',0,'BUY','PostBankRussia', "Q17",a)
        insertvalue('RUB',0,'BUY','PostBankRussia', "R17",a)
